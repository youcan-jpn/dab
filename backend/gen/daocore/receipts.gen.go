...
func SelectReceiptByShopID(ctx context.Context, txn *sql.Tx, shop_id *int) ([]*Receipt, error) {
	eq := squirrel.Eq{}
	if shop_id != nil {
		eq["shop_id"] = *shop_id
	}
...
func DeleteReceiptByCurrencyID(ctx context.Context, txn *sql.Tx, currency_id int) error {
	query, params, err := squirrel.
		Delete(ReceiptTableName).
		Where(squirrel.Eq{
...
func DeleteReceiptByShopID(ctx context.Context, txn *sql.Tx, shop_id int) error {
	query, params, err := squirrel.
		Delete(ReceiptTableName).
		Where(squirrel.Eq{
			"shop_id": shop_id,
